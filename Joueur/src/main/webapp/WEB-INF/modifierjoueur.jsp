...
<input type="hidden" name="id" value="${joueur.id}">
  <div class="form-row">
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control" style="width:400px;" id="validationCustom01" name="Nom" value=${joueur.nom} required>
  ...
  <div class="form-row">
	<div class="col-md-4 mb-3">
	  ...
	  <input type="text" class="form-control" style="width:400px;" id="validationCustom02" name="Prenom" value=${joueur.prenom} required>
	  <div class="valid-feedback">
       Très bien!
     </div>
	</div>
