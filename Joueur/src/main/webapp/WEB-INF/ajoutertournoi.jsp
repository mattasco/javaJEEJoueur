...
<form class="needs-validation "  novalidate method="post" action="AjouterTournoi">
  ...
  <div class="form-row">
	<div class="col-md-4 mb-3">
	  ...
	  <input type="text" class="form-control" style="width:400px;" id="validationCustom02" name="Code" required>
	  <div class="valid-feedback">
       Très bien!
     </div>
	</div>
  ...
  <button class="btn btn-primary center" type="submit">Ajouter tournoi</button>
</form>
