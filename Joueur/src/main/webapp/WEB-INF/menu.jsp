    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdown01">
          <a class="dropdown-item" href="/Joueur/AjouterJoueur">Ajouter un joueur</a>
          <a class="dropdown-item" href="/Joueur/AjouterTournoi">Ajouter un tournoi</a>
        </div>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Lister</a>
        <div class="dropdown-menu" aria-labelledby="dropdown01">
          <a class="dropdown-item" href="/Joueur/Listjoueur">Lister les joueurs</a>
          <a class="dropdown-item" href="/Joueur/Listtournoi">Lister les tournois</a>
        </div>
      </li>
