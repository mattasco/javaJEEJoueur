...
<form class="needs-validation "  novalidate method="post" action="AjouterJoueur">
  <div class="form-row">
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control" style="width:400px;" id="validationCustom01" name="Nom" required>
  ...
  <div class="form-row">
	<div class="col-md-4 mb-3">
	  ...
	  <input type="text" class="form-control" style="width:400px;" id="validationCustom02" name="Prenom" required>
	  <div class="valid-feedback">
       Très bien!
     </div>
	</div>
  ...
  <div class="form-row">
    <div class="col-md-3 mb-3">
      ...
      <select class="custom-select" id="validationCustom04" name="Sexe" style="width:400px;" required>
  ...
  <button class="btn btn-primary center" type="submit">Ajouter joueur</button>
</form>
